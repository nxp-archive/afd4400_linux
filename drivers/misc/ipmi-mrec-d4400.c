...
int d4400_mrec_decode_v100(struct ipmi_record_hdr **rechdr, int num_rec,
...
int d4400_mrec_decode_v101(struct ipmi_record_hdr **rechdr, int num_rec,
	struct fsl_4t4r_board *bi)
{
	int ret = 0;
	int i;
...
/*
 * d4400_mrec_decode - Decodes the given IPMI multi-record.
 *
 * mrecs - input
 * version - output
 * board_info - output
	...
	struct fsl_4t4r_board *bi)
{
	...
	*version = 0;
	...
	case 0x00010000: /* v01.00 */
		ret = d4400_mrec_decode_v100(mrecs->rechdr,
			mrecs->num_rec, bi);
		break;
	case 0x00010001: /* v01.01 */
		ret = d4400_mrec_decode_v101(mrecs->rechdr,
			mrecs->num_rec, bi);
		break;
	default:
	case 0:
