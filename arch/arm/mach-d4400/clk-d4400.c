...
static const char *trace_sels[] = {"mmdc", "sys_pll", "tbgen_pll"};
...
int __init d4400_clocks_init(void)
{
	...
	clk[ip] = clk_register_divider(NULL, "ip", "ahb",
				...
				0, &d4400_ccm_lock);
	clk[gpc] = clk_register_divider(NULL, "gpc", "ipg",
	...
	clk[sync_ckil] = clk_register_fixed_factor(NULL, "sync_ckil",
				"osc1_dev", CLK_SET_RATE_PARENT, 1, 4096);
	clk[ecspi1_sel] = clk_register_mux(NULL, "ecpsi1_sel", ecspi1_sels,
	...
	clk[ecspi1_clk] = clk_register_divider(NULL, "ecspi1_clk", "ecspi1_sel",
				...
				0, &d4400_ccm_lock);
	clk[ecspi2_sel] = clk_register_mux(NULL, "ecpsi2_sel", ecspi2_sels,
	...
	clk[ecspi2_clk] = clk_register_divider(NULL, "ecspi2_clk", "ecspi2_sel",
				...
				0, &d4400_ccm_lock);
	clk[ecspi3_sel] = clk_register_mux(NULL, "ecpsi3_sel", ecspi3_sels,
	...
	clk[ecspi3_clk] = clk_register_divider(NULL, "ecspi3_clk", "ecspi3_sel",
				...
				0, &d4400_ccm_lock);
	clk[ecspi4_sel] = clk_register_mux(NULL, "ecpsi4_sel", ecspi4_sels,
	...
	clk[ecspi4_clk] = clk_register_divider(NULL, "ecspi4_clk", "ecspi4_sel",
				...
				0, &d4400_ccm_lock);
	clk[ecspi5_sel] = clk_register_mux(NULL, "ecpsi5_sel", ecspi5_sels,
	...
	clk[ecspi5_clk] = clk_register_divider(NULL, "ecspi5_clk", "ecspi5_sel",
				...
				0, &d4400_ccm_lock);
	clk[ecspi6_sel] = clk_register_mux(NULL, "ecpsi6_sel", ecspi6_sels,
	...
	clk[ecspi6_clk] = clk_register_divider(NULL, "ecspi6_clk", "ecspi6_sel",
				...
				0, &d4400_ccm_lock);
	clk[ecspi7_sel] = clk_register_mux(NULL, "ecpsi7_sel", ecspi7_sels,
	...
	clk[ecspi7_clk] = clk_register_divider(NULL, "ecspi7_clk", "ecspi7_sel",
				...
				0, &d4400_ccm_lock);
	clk[ecspi8_sel] = clk_register_mux(NULL, "ecps8_sel", ecspi8_sels,
