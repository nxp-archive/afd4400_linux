...
#define FREQ_MULTIPLE_3_686_GHZ		(0x5 << 16)
...
#define SRDS_PLLCR_RCLKEN_BIT		7
...
#define SRDS_GRP_PROT_CPRIG6_SINGLE_CHANNEL	(0X2 << 8)
#define SRDS_GRP_PROT_CPRIG6_DOUBLE_CHANNEL	(0X6 << 8)
...
#define SRDS_GRP_PROT_JESDG1_SINGLE_CHANNEL	0X1
#define SRDS_GRP_PROT_JESDG2_CFG_BITS		0XF
#define SRDS_GRP_PROT_JESDG2_CFG_MASK		(0XF << 24)
#define SRDS_GRP_PROT_JESDG2_DOUBLE_CHANNEL	0X2
...
#define SRDS_CPRI_PROTO_CTRL_TX_DLY_BITS	0xFFFF
...
#define SRDS_LN_GCR_PROTS_SEL_MASK		(0x1F << 7)
...
#define SRDS_LN_TTLCR_DIV20_RCVCLK_BIT	0x1
